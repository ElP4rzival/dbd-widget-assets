...
.bbits.visible {
  ...
  filter: drop-shadow(0 10px 32px rgba(220, 20, 60, 0.3));
}
...
.bbits-bar {
  ...
  border-radius: 12px;
  overflow: visible;
  background: linear-gradient(135deg, rgba(16, 16, 18, 0.8), rgba(12, 12, 14, 0.92));
  box-shadow: 0 0 18px rgba(220, 20, 60, 0.35), inset 0 0 10px rgba(255, 255, 255, 0.08);
...
.bbits-bar::before {
  ...
  inset: -12px;
  border-radius: 16px;
  background: radial-gradient(circle at 50% 50%, rgba(220, 20, 60, 0.15), transparent 55%);
  filter: blur(8px);
  opacity: 0.5;
  pointer-events: none;
}
...
.bbits-bar-fill {
  ...
  width: 0%;
  border-radius: 10px;
  background: linear-gradient(90deg, rgba(220, 20, 60, 0.9), rgba(160, 18, 42, 0.95));
  box-shadow: inset 0 0 18px rgba(255, 255, 255, 0.18), 0 0 22px rgba(220, 20, 60, 0.32);
...
.bbits-bar-glow {
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 20% 50%, rgba(255, 255, 255, 0.22), transparent 40%),
    radial-gradient(circle at 80% 50%, rgba(255, 255, 255, 0.12), transparent 45%);
  opacity: 0.8;
...
.bbits-bar-scratches {
  position: absolute;
  inset: 0;
  background-image: linear-gradient(135deg, rgba(255, 255, 255, 0.12) 0 22%, transparent 22% 100%),
    linear-gradient(145deg, rgba(220, 20, 60, 0.16) 0 18%, transparent 18% 100%),
    linear-gradient(155deg, rgba(255, 255, 255, 0.08) 0 14%, transparent 14% 100%);
  background-size: 12% 100%, 10% 100%, 8% 100%;
...
.bbits-bar-numbers {
  ...
  gap: 6px;
  font-weight: 700;
  text-shadow: 0 0 8px rgba(255, 255, 255, 0.65), 0 0 14px rgba(255, 255, 255, 0.45),
    0 0 24px rgba(220, 20, 60, 0.35);
}
...
#bbits-root.effect-tier-high .bbits-particles,
#bbits-root.effect-tier-max .bbits-particles {
  opacity: 0.95;
}

.bbits.visible.effect-pulse {
  animation: bbits-pulse 1s ease-out;
}

.bbits.visible.effect-glow-soft {
  animation: bbits-glow-soft 1s ease-out;
}
...
.bbits.visible.effect-flash::after {
  content: '';
  position: absolute;
  inset: -10px;
  background: radial-gradient(circle at center, rgba(255, 255, 255, 0.7), transparent 60%);
  opacity: 0;
  animation: bbits-flash 820ms ease;
  mix-blend-mode: screen;
}

.bbits.visible.effect-vignette::before {
  content: '';
  position: absolute;
  inset: -18px;
  background: radial-gradient(circle at center, transparent 50%, rgba(0, 0, 0, 0.55) 95%);
  opacity: 0;
  animation: bbits-vignette 880ms ease;
  pointer-events: none;
}

.bbits.visible.effect-scanline .bbits-bar-overlay::after {
  content: '';
  position: absolute;
  inset: -4px;
  background: linear-gradient(90deg, rgba(220, 20, 60, 0) 0%, rgba(220, 20, 60, 0.6) 50%, rgba(220, 20, 60, 0) 100%);
  mix-blend-mode: screen;
  animation: bbits-scanline 900ms ease-out;
}

.bbits.visible.effect-scratch::after {
  content: '';
  position: absolute;
  inset: -6px;
  background: repeating-linear-gradient(
    ...
    repeating-linear-gradient(
      150deg,
      rgba(220, 20, 60, 0.16),
      rgba(220, 20, 60, 0.16) 6px,
      transparent 6px,
      transparent 12px
    );
  background-size: 14% 100%, 12% 100%;
  mix-blend-mode: screen;
  opacity: 0;
  animation: bbits-scratch 820ms ease-out;
}

.bbits.visible.effect-bloodmist::after {
  content: '';
  position: absolute;
  inset: -16px;
  border-radius: 18px;
  background: radial-gradient(circle at center, rgba(220, 20, 60, 0.42), transparent 62%);
  filter: blur(4px);
  opacity: 0;
  animation: bbits-bloodmist 1100ms ease-out;
}

.bbits.visible.effect-claws::after {
  content: '';
  position: absolute;
  inset: -10px;
  background: linear-gradient(135deg, rgba(255, 255, 255, 0.15) 0 18%, transparent 18% 100%),
    linear-gradient(145deg, rgba(220, 20, 60, 0.22) 0 18%, transparent 18% 100%);
  background-size: 14% 100%, 12% 100%;
  background-repeat: repeat;
  mix-blend-mode: screen;
  opacity: 0;
  animation: bbits-claws 1s ease-out;
}

.bbits.visible.effect-afterimage::before {
  content: '';
  position: absolute;
  inset: -6px;
  border-radius: 14px;
  background: linear-gradient(90deg, rgba(255, 255, 255, 0.28), rgba(220, 20, 60, 0.16));
  opacity: 0;
  filter: blur(5px);
  animation: bbits-afterimage 1.2s ease-out;
}
...
@keyframes bbits-pulse {
  ...
  45% {
    transform: translateY(-2px) scale(calc(var(--bbits-scale) * 1.02));
  }
  100% {
    transform: translateY(0) scale(var(--bbits-scale));
  }
...
@keyframes bbits-glow-soft {
  0% {
    box-shadow: 0 0 18px rgba(220, 20, 60, 0.35);
  }
  45% {
    box-shadow: 0 0 26px rgba(220, 20, 60, 0.55);
  }
  100% {
    box-shadow: 0 0 18px rgba(220, 20, 60, 0.35);
  }
 ...
 * 1-9 (t0): pulse suave + microglow
 * 10-24 (t1): pulse + scanline rojo rápido
 * 25-49 (t2): scratch-flash + pulse
 * 50-99 (t3): shake breve + scratch + scanline
 * 100-249 (t4): flash blanco controlado + vignette breve
 * 250-499 (t5): blood mist burst + shake
 * 500-999 (t6): claws streaks + partículas low
 * 1000-1499 (t7): cinematic flash + partículas + glow boost
 * 1500+ (max): mori effect (flash + afterimage + partículas high + shake suave)
 */
...
(function () {
  ...
  function startAutoCycle() {
    ...
    const run = () => {
      showBar('auto', 'effect-pulse effect-glow-soft');
  ...
  function applyTierEffect(tier) {
    const map = {
      ...
      t3: 'effect-shake effect-scratch effect-scanline',
      t4: 'effect-flash effect-vignette',
      t5: 'effect-bloodmist effect-shake',
      t6: 'effect-claws effect-pulse effect-tier-high',
      t7: 'effect-flash effect-tier-high effect-pulse effect-afterimage',
      max: 'effect-flash effect-afterimage effect-tier-max effect-shake',
    };
    const cls = map[tier] || 'effect-pulse';
    showBar('donation', cls);
    if (tier === 't6' || tier === 't7' || tier === 'max') {
  ...
  function triggerParticles(tier) {
    ...
    const density = state.settings.particleMode === 'high' || tier === 'max' ? 34 : 18;
    const particles = [];
    ...
    function loop(now) {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = p.life % 2 ? 'rgba(220,20,60,0.85)' : 'rgba(245,245,245,0.7)';
        ctx.beginPath();
        ctx.arc(p.x, p.y, p.size, 0, Math.PI * 2);
        ctx.fill();
      });
      if (elapsed < 1100) requestAnimationFrame(loop);
  ...
  function handleCommand(text, event) {
    ...
    switch (sub) {
      case 'show':
        showBar('donation', 'effect-pulse effect-glow-soft');
        break;
      case 'hide':
        hideBar();
        break;
      ...
      default:
        ...
        else showBar('donation', 'effect-pulse effect-glow-soft');
        break;
    }
  }
